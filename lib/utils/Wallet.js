...
class Wallet {
    constructor(seed) {
        ...
        this.getStealthAddress = (account, index) => {
            ...
            return ChainXSHelper_1.ChainXSHelper.encodeBWSAddress(ChainXSHelper_1.ChainXSAddressType.SAA, node.address);
        };
        ...
        this.address = this.getAddress(ChainXSHelper_1.ChainXSAddressType.EOA);
    }
}
