...
exports.ChainXSApiV2_WS = void 0;
const utils_1 = require("../utils");
const ws_1 = __importDefault(require("ws"));
const genRanHex = (size) => [...Array(size)].map(() => Math.floor(Math.random() * 16).toString(16)).join('');
class ChainXSApiV2_WS {
    constructor(debug) {
    ...
    getSocket(host) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let i = 0; i < 300 && !isOpen; i++) {
                yield utils_1.ChainXSHelper.sleep(100);
                if (error) {
                    this.connections.delete(host);
    ...
    post(host_1, path_1, token_1) {
        return __awaiter(this, arguments, void 0, function* (host, path, token, parameters = {}, broadcast) {
            const req = {
                id: genRanHex(40),
                broadcast: broadcast,
                path: path,
...
exports.ChainXSApiV2_WS = ChainXSApiV2_WS;
