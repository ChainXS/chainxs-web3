...
class ContractActions {
    constructor(web3) {
        this.readContract = (chain, contractAddress, method, inputs) => __awaiter(this, void 0, void 0, function* () {
            let simulateTx = {
                chain: chain,
                from: [utils_1.ChainXSHelper.ZERO_ADDRESS],
                to: [contractAddress],
                amount: ['0'],
                type: types_1.TxType.TX_CONTRACT,
                data: [{ method, inputs }],
                foreignKeys: [],
            };
        ...
        this.simulateContract = (sc) => __awaiter(this, void 0, void 0, function* () {
            const node = this.web3.network.getRandomNode();
            let simulate = yield this.web3.network.getAPI(node).trySimulate(node, sc);
            if (simulate.error) {
                throw new Error(`Can't simulate transaction - details: ${simulate.data.error}`);
            }
            ;
        ...
        this.getContractByAddress = (chain, address) => __awaiter(this, void 0, void 0, function* () {
            return yield this.web3.network.findAll((node) => __awaiter(this, void 0, void 0, function* () {
                let req = yield this.web3.network.getAPI(node).getContractByAddress(node, chain, address);
                if (!req.error) {
                    return req.data;
                }
            }));
        ...
        this.getContractEventByAddress = (chain, address, event, byKey) => __awaiter(this, void 0, void 0, function* () {
            return yield this.web3.network.findAll((node) => __awaiter(this, void 0, void 0, function* () {
                let req = yield this.web3.network.getAPI(node).getContractEventByAddress(node, chain, address, event, byKey);
                if (!req.error) {
                    return req.data;
                }
            }));
